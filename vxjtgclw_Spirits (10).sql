...
(55, 1, 'Login', 'User logged in successfully', '41.209.14.78', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', NULL, '2025-10-08 11:26:15'),
(56, 1, 'BRANCH_DELETED', 'Deleted branch ID: 2', '41.209.14.78', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', NULL, '2025-10-08 11:28:26'),
(57, 1, 'REGISTER_OPENED', 'Opened register with float: KSh 3,000.00', '41.209.14.78', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', NULL, '2025-10-08 11:57:37'),
(58, 1, 'LOGOUT', 'User logged out', '41.209.14.78', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', NULL, '2025-10-08 12:50:18'),
(59, 1, 'Login', 'User logged in successfully', '41.209.14.78', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', NULL, '2025-10-08 12:50:22'),
(60, 1, 'Login', 'User logged in successfully', '41.209.14.78', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', NULL, '2025-10-08 13:02:54');
...
--
-- Table structure for table `breakeven_snapshots`
--

CREATE TABLE `breakeven_snapshots` (
  `id` int NOT NULL,
  `period_month` date NOT NULL,
  `total_fixed_costs` decimal(15,2) NOT NULL DEFAULT '0.00',
  `total_variable_costs` decimal(15,2) NOT NULL DEFAULT '0.00',
  `total_revenue` decimal(15,2) NOT NULL DEFAULT '0.00',
  `total_units_sold` int NOT NULL DEFAULT '0',
  `avg_selling_price` decimal(15,2) NOT NULL DEFAULT '0.00',
  `avg_variable_cost` decimal(15,2) NOT NULL DEFAULT '0.00',
  `breakeven_units` int NOT NULL DEFAULT '0',
  `breakeven_revenue` decimal(15,2) NOT NULL DEFAULT '0.00',
  `actual_profit` decimal(15,2) NOT NULL DEFAULT '0.00',
  `breakeven_achieved` tinyint(1) NOT NULL DEFAULT '0',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `cash_register_sessions` (
  ...
  `total_mpesa_sales` decimal(10,2) DEFAULT '0.00',
...
INSERT INTO `cash_register_sessions` (`id`, `user_id`, `branch_id`, `opening_float`, `closing_float`, `expected_cash`, `actual_cash`, `variance`, `total_sales`, `total_cash_sales`, `total_mpesa_sales`, `total_card_sales`, `sales_count`, `opened_at`, `closed_at`, `status`, `notes`, `created_at`) VALUES
(1, 1, NULL, 3000.00, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, 0.00, 0, '2025-10-08 14:57:37', NULL, 'open', '', '2025-10-08 11:57:37');
...
CREATE TABLE `customers` (
  ...
  `online_orders_count` int DEFAULT '0',
  `visit_count` int NOT NULL DEFAULT '0',
  `last_visit` datetime DEFAULT NULL,
  `last_purchase` datetime DEFAULT NULL,
  `last_online_order` datetime DEFAULT NULL,
...
CREATE TABLE `delivery_zones` (
  ...
  `estimated_time` varchar(50) DEFAULT '30-60 mins',
...
INSERT INTO `delivery_zones` (`id`, `zone_name`, `areas`, `delivery_fee`, `min_order_amount`, `estimated_time`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'CBD/City Center', '[\"CBD\", \"Town\", \"City Center\", \"Downtown\"]', 200.00, 500.00, '30-45 mins', 1, '2025-10-08 12:57:13', '2025-10-08 12:57:13'),
(2, 'Westlands/Parklands', '[\"Westlands\", \"Parklands\", \"Spring Valley\", \"Lavington\"]', 300.00, 500.00, '45-60 mins', 1, '2025-10-08 12:57:13', '2025-10-08 12:57:13'),
(3, 'Kilimani/Kileleshwa', '[\"Kilimani\", \"Kileleshwa\", \"Hurlingham\", \"Milimani\"]', 300.00, 500.00, '45-60 mins', 1, '2025-10-08 12:57:13', '2025-10-08 12:57:13'),
(4, 'Karen/Langata', '[\"Karen\", \"Langata\", \"Hardy\", \"Rongai\"]', 500.00, 1000.00, '60-90 mins', 1, '2025-10-08 12:57:13', '2025-10-08 12:57:13'),
(5, 'Eastlands', '[\"Eastlands\", \"Umoja\", \"Donholm\", \"Embakasi\"]', 400.00, 800.00, '60-90 mins', 1, '2025-10-08 12:57:13', '2025-10-08 12:57:13'),
(6, 'CBD/City Center', '[\"CBD\", \"Town\", \"City Center\", \"Downtown\"]', 200.00, 500.00, '30-45 mins', 1, '2025-10-08 12:58:37', '2025-10-08 12:58:37'),
(7, 'Westlands/Parklands', '[\"Westlands\", \"Parklands\", \"Spring Valley\", \"Lavington\"]', 300.00, 500.00, '45-60 mins', 1, '2025-10-08 12:58:37', '2025-10-08 12:58:37'),
(8, 'Kilimani/Kileleshwa', '[\"Kilimani\", \"Kileleshwa\", \"Hurlingham\", \"Milimani\"]', 300.00, 500.00, '45-60 mins', 1, '2025-10-08 12:58:37', '2025-10-08 12:58:37'),
(9, 'Karen/Langata', '[\"Karen\", \"Langata\", \"Hardy\", \"Rongai\"]', 500.00, 1000.00, '60-90 mins', 1, '2025-10-08 12:58:37', '2025-10-08 12:58:37'),
(10, 'Eastlands', '[\"Eastlands\", \"Umoja\", \"Donholm\", \"Embakasi\"]', 400.00, 800.00, '60-90 mins', 1, '2025-10-08 12:58:37', '2025-10-08 12:58:37');
...
--
-- Table structure for table `online_ordering_config`
--

CREATE TABLE `online_ordering_config` (
  `id` int NOT NULL,
  `is_enabled` tinyint(1) DEFAULT '1',
  `allow_guest_orders` tinyint(1) DEFAULT '1',
  `require_phone_verification` tinyint(1) DEFAULT '0',
  `min_order_amount` decimal(10,2) DEFAULT '0.00',
  ...
  `estimated_prep_time` varchar(50) DEFAULT '30 mins',
  `auto_confirm_orders` tinyint(1) DEFAULT '0',
  `order_notification_email` varchar(255) DEFAULT NULL,
  `order_notification_phone` varchar(50) DEFAULT NULL,
...
--
-- Dumping data for table `online_ordering_config`
--

INSERT INTO `online_ordering_config` (`id`, `is_enabled`, `allow_guest_orders`, `require_phone_verification`, `min_order_amount`, `max_order_amount`, `default_delivery_fee`, `free_delivery_above`, `estimated_prep_time`, `auto_confirm_orders`, `order_notification_email`, `order_notification_phone`, `terms_and_conditions`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 0, 0.00, 100000.00, 0.00, 0.00, '30 mins', 0, NULL, NULL, NULL, '2025-10-08 12:57:13', '2025-10-08 12:57:13'),
(2, 1, 1, 0, 0.00, 100000.00, 0.00, 0.00, '30 mins', 0, NULL, NULL, NULL, '2025-10-08 12:58:37', '2025-10-08 12:58:37');
...
CREATE TABLE `online_orders` (
  ...
  `status` enum('pending','confirmed','processing','ready','out_for_delivery','completed','cancelled') DEFAULT 'pending',
...
INSERT INTO `permissions` (`id`, `name`, `code`, `description`, `category`, `created_at`) VALUES
(1, 'Give Discounts', 'can_give_discounts', 'Allow user to apply discounts to sales', 'sales', '2025-10-08 13:19:56'),
(2, 'Void Sales', 'can_void_sales', 'Allow user to void/cancel sales transactions', 'sales', '2025-10-08 13:19:56'),
(3, 'Process Refunds', 'can_process_refunds', 'Allow user to process refund transactions', 'sales', '2025-10-08 13:19:56'),
(4, 'Modify Prices', 'can_modify_prices', 'Allow user to change product prices', 'inventory', '2025-10-08 13:19:56'),
(5, 'Manage Inventory', 'can_manage_inventory', 'Allow user to add/edit/delete products', 'inventory', '2025-10-08 13:19:56'),
(6, 'Adjust Stock', 'can_adjust_stock', 'Allow user to manually adjust stock levels', 'inventory', '2025-10-08 13:19:56'),
(7, 'View Reports', 'can_view_reports', 'Allow user to view sales and analytics reports', 'reports', '2025-10-08 13:19:56'),
(8, 'View All Sales', 'can_view_all_sales', 'Allow user to view sales from all sellers', 'reports', '2025-10-08 13:19:56'),
(9, 'Manage Users', 'can_manage_users', 'Allow user to create and manage user accounts', 'admin', '2025-10-08 13:19:56'),
(10, 'Manage Settings', 'can_manage_settings', 'Allow user to change system settings', 'admin', '2025-10-08 13:19:56'),
(11, 'View Expenses', 'can_view_expenses', 'Allow user to view expense records', 'finance', '2025-10-08 13:19:56'),
(12, 'Manage Expenses', 'can_manage_expenses', 'Allow user to add/edit/delete expenses', 'finance', '2025-10-08 13:19:56'),
(13, 'Delete Products', 'can_delete_products', 'Allow user to delete products', 'inventory', '2025-10-08 13:19:56'),
(14, 'Manage Categories', 'can_manage_categories', 'Allow user to manage product categories', 'inventory', '2025-10-08 13:19:56'),
(15, 'View Audit Logs', 'can_view_audit_logs', 'Allow user to view system audit logs', 'admin', '2025-10-08 13:19:56');
...
INSERT INTO `sales` (`id`, `sale_number`, `user_id`, `register_session_id`, `branch_id`, `customer_id`, `subtotal`, `tax_amount`, `discount_amount`, `discount_reason`, `discount_approved_by`, `total_amount`, `payment_method`, `mpesa_reference`, `amount_paid`, `change_amount`, `sale_date`, `notes`, `is_voided`, `void_reason`, `voided_by`, `voided_at`, `created_at`) VALUES
(1, 'ZWS-20251007-7F0A8A', 1, NULL, 1, NULL, 1800.00, 0.00, 0.00, NULL, NULL, 1800.00, 'cash', NULL, 1800.00, 0.00, '2025-10-07 13:33:43', NULL, 0, NULL, NULL, NULL, '2025-10-07 10:33:43'),
(2, 'ZWS-20251007-B0487D', 1, NULL, 1, NULL, 380.00, 0.00, 0.00, NULL, NULL, 380.00, 'cash', NULL, 380.00, 0.00, '2025-10-07 13:34:35', NULL, 0, NULL, NULL, NULL, '2025-10-07 10:34:35'),
(3, 'ZWS-20251007-51D8F6', 2, NULL, 1, NULL, 2300.00, 0.00, 0.00, NULL, NULL, 2300.00, 'cash', NULL, 2300.00, 0.00, '2025-10-07 13:48:05', NULL, 0, NULL, NULL, NULL, '2025-10-07 10:48:05'),
(4, 'ZWS-20251007-4C7E8D', 1, NULL, 1, NULL, 2300.00, 0.00, 0.00, NULL, NULL, 2300.00, 'cash', NULL, 2300.00, 0.00, '2025-10-07 14:19:32', NULL, 0, NULL, NULL, NULL, '2025-10-07 11:19:32'),
(5, 'ZWS-20251007-7E7391', 1, NULL, 1, NULL, 2300.00, 0.00, 0.00, NULL, NULL, 2300.00, 'cash', NULL, 2300.00, 0.00, '2025-10-07 14:26:15', NULL, 0, NULL, NULL, NULL, '2025-10-07 11:26:16'),
(17, 'ZWS-20251007-030C0D', 1, NULL, 1, NULL, 190.00, 0.00, 0.00, NULL, NULL, 190.00, 'cash', NULL, 190.00, 0.00, '2025-10-07 17:47:06', '', 0, NULL, NULL, NULL, '2025-10-07 14:47:07'),
(18, 'ZWS-20251007-162357', 1, NULL, 1, NULL, 2300.00, 0.00, 0.00, NULL, NULL, 2300.00, 'cash', NULL, 2300.00, 0.00, '2025-10-07 17:47:57', '', 0, NULL, NULL, NULL, '2025-10-07 14:47:57'),
(19, 'ZWS-20251007-69C4A8', 1, NULL, 1, NULL, 4100.00, 0.00, 0.00, NULL, NULL, 4100.00, 'cash', NULL, 4100.00, 0.00, '2025-10-07 17:48:19', '', 0, NULL, NULL, NULL, '2025-10-07 14:48:19'),
(20, 'ZWS-20251007-29D876', 1, NULL, 1, NULL, 1990.00, 0.00, 0.00, NULL, NULL, 1990.00, 'cash', NULL, 2000.00, 10.00, '2025-10-07 17:59:13', '', 0, NULL, NULL, NULL, '2025-10-07 14:59:13'),
(21, 'ZWS-20251008-06DA53', 2, NULL, 1, NULL, 3600.00, 0.00, 0.00, NULL, NULL, 3600.00, 'cash', '', 3600.00, 0.00, '2025-10-08 10:19:47', '', 0, NULL, NULL, NULL, '2025-10-08 07:19:47'),
(22, 'ZWS-20251008-90CC03', 2, NULL, 1, NULL, 1200.00, 0.00, 0.00, NULL, NULL, 1200.00, 'mpesa', '-', 1200.00, 0.00, '2025-10-08 10:20:35', '', 0, NULL, NULL, NULL, '2025-10-08 07:20:35'),
(23, 'ZWS-20251008-F48590', 1, NULL, 1, NULL, 4000.00, 0.00, 0.00, NULL, NULL, 4000.00, 'cash', '', 4000.00, 0.00, '2025-10-08 11:23:27', '', 0, NULL, NULL, NULL, '2025-10-08 08:23:27'),
(24, 'ZWS-20251008-BE6D59', 1, NULL, 1, NULL, 250.00, 0.00, 0.00, NULL, NULL, 250.00, 'cash', '', 250.00, 0.00, '2025-10-08 11:55:33', '', 0, NULL, NULL, NULL, '2025-10-08 08:55:33');
...
(23, 1, 'add061847e3ee0d4bc80aa8afb90adc2ed4f04bec4fdd277c039a6787817d7f7', '41.209.14.78', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-10-08 08:54:23', '2025-10-08 12:50:18', '2025-10-08 12:50:18'),
(24, 1, 'e5679e93870661043a61f3c09ca150517db109932820c3b8367817c73800c026', '41.209.14.78', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', '2025-10-08 09:32:26', '2025-10-08 12:50:18', '2025-10-08 12:50:18'),
(25, 1, '2ee4ca3d6625596448a914a66438236191d93877f95cd88c5b268fa6bbe3c8d0', '41.209.14.78', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', '2025-10-08 11:26:15', '2025-10-08 12:50:18', '2025-10-08 12:50:18'),
(26, 1, '43b9d7549a0e60aef8a10af8e6977b782e14123ceff8ffed24ca1c4460481a5d', '41.209.14.78', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', '2025-10-08 12:50:22', '2025-10-08 12:50:22', NULL),
(27, 1, 'f7bc1b1ed3106da625536d7569f8c9f528c8a24ff0fac8c3aceb72abdf024461', '41.209.14.78', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', '2025-10-08 13:02:54', '2025-10-08 13:02:54', NULL);
...
CREATE TABLE `whatsapp_config` (
  ...
  `send_receipts` tinyint(1) DEFAULT '1',
  `send_low_stock_alerts` tinyint(1) DEFAULT '1',
  `send_daily_summary` tinyint(1) DEFAULT '1',
...
INSERT INTO `whatsapp_config` (`id`, `provider`, `account_sid`, `auth_token`, `from_number`, `admin_number`, `daily_summary_time`, `low_stock_threshold`, `send_receipts`, `send_low_stock_alerts`, `send_daily_summary`, `api_status`, `last_tested_at`, `created_at`, `updated_at`) VALUES
(1, 'twilio', NULL, NULL, '+254700000000', '+254700000000', '18:00:00', 10, 1, 1, 1, 'inactive', NULL, '2025-10-08 12:31:04', '2025-10-08 12:31:04');
...
INSERT INTO `whatsapp_templates` (`id`, `template_name`, `template_type`, `template_content`, `variables`, `is_active`, `usage_count`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 'receipt_default', 'receipt', '🧾 *RECEIPT - {company_name}*\n\n📋 Sale #: {sale_number}\n📅 Date: {date}\n⏰ Time: {time}\n👤 Served by: {seller}\n\n📦 *ITEMS*\n{items}\n\n💰 *PAYMENT SUMMARY*\nSubtotal: {subtotal}\nTax: {tax}\nTotal: {total}\nPaid: {paid}\nChange: {change}\nMethod: {payment_method}\n\n✅ Thank you for your business!\n{footer}', '[\"company_name\", \"sale_number\", \"date\", \"time\", \"seller\", \"items\", \"subtotal\", \"tax\", \"total\", \"paid\", \"change\", \"payment_method\", \"footer\"]', 1, 0, NULL, '2025-10-08 12:31:04', '2025-10-08 12:31:04'),
(2, 'low_stock_alert', 'low_stock', '⚠️ *LOW STOCK ALERT*\n\n📦 Product: {product_name}\n📊 Current Stock: {current_stock}\n🔔 Reorder Level: {reorder_level}\n📍 Branch: {branch}\n\nPlease restock soon!', '[\"product_name\", \"current_stock\", \"reorder_level\", \"branch\"]', 1, 0, NULL, '2025-10-08 12:31:04', '2025-10-08 12:31:04'),
(3, 'daily_summary', 'daily_summary', '📊 *DAILY SALES SUMMARY*\n\n📅 Date: {date}\n\n💰 *REVENUE*\nTotal Sales: {total_sales}\nTotal Revenue: {total_revenue}\nAvg Sale: {avg_sale}\n\n💳 *PAYMENT METHODS*\nCash: {cash_sales}\nM-Pesa: {mpesa_sales}\nCard: {card_sales}\n\n📦 *TOP PRODUCTS*\n{top_products}\n\n👥 *TOP SELLERS*\n{top_sellers}\n\n✅ Great work today!', '[\"date\", \"total_sales\", \"total_revenue\", \"avg_sale\", \"cash_sales\", \"mpesa_sales\", \"card_sales\", \"top_products\", \"top_sellers\"]', 1, 0, NULL, '2025-10-08 12:31:04', '2025-10-08 12:31:04');
...
--
-- Indexes for table `breakeven_snapshots`
--
ALTER TABLE `breakeven_snapshots`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `period_month` (`period_month`);
...
--
-- Indexes for table `online_ordering_config`
--
ALTER TABLE `online_ordering_config`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `sales`
  ...
  ADD KEY `register_session_id` (`register_session_id`);
...
--
-- AUTO_INCREMENT for table `breakeven_snapshots`
--
ALTER TABLE `breakeven_snapshots`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `online_ordering_config`
--
ALTER TABLE `online_ordering_config`
...
ALTER TABLE `cash_register_sessions`
  ...
  ADD CONSTRAINT `cash_register_sessions_ibfk_2` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`id`);

--
-- Constraints for table `cash_register_transactions`
--
ALTER TABLE `cash_register_transactions`
  ADD CONSTRAINT `cash_register_transactions_ibfk_1` FOREIGN KEY (`session_id`) REFERENCES `cash_register_sessions` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `online_orders`
  ADD CONSTRAINT `online_orders_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `online_orders_ibfk_2` FOREIGN KEY (`assigned_to`) REFERENCES `users` (`id`) ON DELETE SET NULL;
...
ALTER TABLE `online_order_items`
  ...
  ADD CONSTRAINT `online_order_items_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `order_status_history`
--
ALTER TABLE `order_status_history`
  ADD CONSTRAINT `order_status_history_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `online_orders` (`id`) ON DELETE CASCADE,
...
ALTER TABLE `sales`
  ...
  ADD CONSTRAINT `sales_ibfk_3` FOREIGN KEY (`register_session_id`) REFERENCES `cash_register_sessions` (`id`);
